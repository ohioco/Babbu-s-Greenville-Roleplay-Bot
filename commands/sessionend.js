...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setTitle("Babbu's Greenville Roleplay™ | Session Ended 🔴")
      .setColor(BABY_BLUE)
      .setDescription(
`<@&1508054312075526204>

➜ The Babbu's Greenville Roleplay session hosted by ${host} has now concluded.
...
-# Keep an eye out for future session announcements.`
      ...
      .setFooter({ text: "Babbu's Greenville Roleplay™ | Session Management" })
      .setTimestamp();
