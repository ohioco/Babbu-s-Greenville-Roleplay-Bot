...
module.exports = {
  ...
  async execute(message) {
    ...
    const embed1 = new EmbedBuilder()
      .setTitle("Babbu's Greenville Roleplay™ | Server Alliances")
      .setColor(BABY_BLUE)
    ...
    const embed2 = new EmbedBuilder()
      ...
      .setColor(BABY_BLUE)
      .setDescription(
`Welcome to **Babbu's Greenville Roleplay's** Server Alliances. Within our server, we strive to support all roleplay communities in their growth and success.
...
➜ Organized Server & Departments.`
      ...
      .setFooter({ text: "Babbu's Greenville Roleplay™ | Server Alliances" })
      .setTimestamp();
